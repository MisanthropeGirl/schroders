...
export const stockDataApiResponse = {
  adjusted: true,
  count: 501,
  queryCount: 501,
  request_id: "c39c718e4fff3278d05b284f5cc89049",
  results: A,
  resultsCount: 501,
  status: "DELAYED",
  ticker: "A",
...
A_DATE_RANGE_CHART_DATA["Open"] = dataTransform(
  A_DATE_RANGE_RAW_CHART_DATA,
  PRICE_SERIES_CODES.OPEN,
);
A_DATE_RANGE_CHART_DATA["High"] = dataTransform(
  A_DATE_RANGE_RAW_CHART_DATA,
  PRICE_SERIES_CODES.HIGH,
);
A_DATE_RANGE_CHART_DATA["Low"] = dataTransform(A_DATE_RANGE_RAW_CHART_DATA, PRICE_SERIES_CODES.LOW);
A_DATE_RANGE_CHART_DATA["Close"] = dataTransform(
  A_DATE_RANGE_RAW_CHART_DATA,
  PRICE_SERIES_CODES.CLOSE,
);
